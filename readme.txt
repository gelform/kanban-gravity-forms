...
Text Domain:		kanban-gravity-forms
Domain Path: 		/languages/
Tags:               kanban, gravity forms, integration, adapter
...
1. Make sure you've got Kanban for WordPress and Gravity Forms installed and activated.
...
1. Activate the Kanban + Gravity Forms plugin. This will create a new Kanban > Gravity Forms page in your WordPress admin.
1. On that Kanban > Gavity Forms page, choose your form from the dropdown at the top of the page.
...
For the changelog, please visit [https://kanbanwp.com/addons/gravity-forms/](https://kanbanwp.com/addons/gravity-forms/)
