...
1. Activate the Kanban + Gravity Forms plugin. This will create a new Kanban > Gavity Forms page in your WordPress admin.
...
For the changelog, please visit [https://kanbanwp.com/addons/shortcodes/](https://kanbanwp.com/addons/gravity-forms/)
